...
It is intended as a companion to [TITLE_TRANSFER_AUTHORITY_TRUST_ASSUMPTIONS.md](/Users/trbouma/projects/monstr/docs/TITLE_TRANSFER_AUTHORITY_TRUST_ASSUMPTIONS.md).
